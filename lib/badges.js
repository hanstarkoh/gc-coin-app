...
export const BADGE_DEFS = [
  ...
  { key: 'first_donate', icon: '🎁', name: '나눔이', desc: '기부함에 처음 기부했어요', check: (k) => (k.total_donated || 0) >= 1 },
  { key: 'donate_50', icon: '💝', name: '기부왕', desc: '누적 기부 50 GC 달성', check: (k) => (k.total_donated || 0) >= 50 },
];
