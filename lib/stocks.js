...
// 반영되는 것처럼, 최근 한 달간 이 종목에 뜬 뉴스의 호재/악재 쏠림이 실적 확률을 살짝 더
// 밀어줍니다. 영향력은 제한(±15%p)을 둬서 "뉴스 몇 개 봤다고 무조건 맞힌다"는 정도는
// 안 되게 하고, 펀더멘털처럼 어디까지나 확률을 기울일 뿐 결과를 확정 짓진 않습니다.
export const EARNINGS_NEWS_INFLUENCE = 0.15;
